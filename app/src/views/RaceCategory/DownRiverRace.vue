<template>
          ...
          <b-row>
            ...
            <b-col>
              <div
                ...
                "
              >
              <button type="button" class="btn btn-cyan" @click="toggleSortRanked">Sort Ranked</button>
  ...
  export default {
    ...
    methods: {
      ...
      const matchingRank = this.dataScore.find((data) => data.ranking === ranked);
